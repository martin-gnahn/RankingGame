...
class StartRankedAnswerGameServiceTest {
    @Test
    ...
    private StartRankingGameService service(
        ...
        RoundMapper roundMapper = new RoundMapper(questionMapper, new AnswerMapper(), new RankingMapper(new AnswerMapper()), new PlayerMapper());
